...
<section class="conditions-1">
    <div class="page_nav">
        <div class="page_nav-wrap">
            ...
            <div class="page_nav-box page_nav__desktop">
                ...
                <a href="<?= (Yii::$app->language == 'ru') ? '/in-build/' : '/ua/in-build/' ?>" class="page_nav-item">
                    <svg class="icon-svg-arr">
                        <use xlink:href="/img/sprite.svg#menu_it-arr" xmlns:xlink="http://www.w3.org/1999/xlink"></use>
                    </svg>
            ...
            <div class="page_nav-box page_nav__tablets">
                ...
                <div class="select-dropdown">
                    <a href="<?= (Yii::$app->language == 'ru') ? '/finished-build/' : '/ua/finished-build/' ?>" class="select-dropdown-item current"><?= Yii::t('menu', 'Готовая квартира') ?></a>
                    <a href="<?= (Yii::$app->language == 'ru') ? '/in-build/' : '/ua/in-build/' ?>" class="select-dropdown-item"><?= Yii::t('menu', 'В строящемся доме') ?></a>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        ...
        <div class="conditions_section"><span class="conditions_header"><?= $text['head'] ?></span></div>
    </div>
    <div class="container">
        <div class="conditions_section"></div>
        <div class="conditions_section conditions_section-content">
            <?php foreach ($data as $item): ?>
                <div class="conditions_col">
                    <div class="img"><img src="/img/conditions/<?= $item['image'] ?>" alt="<?= $item['title'] ?>"></div>
